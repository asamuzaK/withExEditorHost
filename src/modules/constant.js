...
"use strict";
{
  ...
  module.exports = {
    CMD_ARGS, CMD_BEFORE_FILE, CONTENT_GET, CONTEXT_MENU, CONTEXT_MODE,
    EDITOR_CONFIG, EDITOR_CONFIG_GET, EDITOR_CONFIG_RES, EDITOR_LABEL,
    EDITOR_PATH, FILE_EXT, IS_ENABLED, KEY_ACCESS, KEY_EDITOR, KEY_OPTIONS,
    LABEL, LABEL_HOST, LOCAL_FILE_VIEW, MASK_BIT, MODE_EDIT, MODE_MATHML,
    MODE_SELECTION, MODE_SOURCE, MODE_SVG, NODE_COMMENT, NODE_ELEMENT,
    NODE_TEXT, NS_URI, ONLY_EDITABLE, OPEN_OPTIONS, PERM_FILE, PERM_DIR,
    PORT_FILE_DATA, SET_VARS, SYNC_TEXT, TMP_FILES, TMP_FILES_PB,
